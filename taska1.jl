...
# m_chaboche = Chaboche(G=80.e3, K=160.e3, Y=250.0, Hiso=100e3, κ∞=400.0, Hkin=0.0, β∞=50.0)
...
t = "Figure 1. Stress-strain graph of a perfectly plastic material for different strain rates."
CM.Label(fig[2,1], t)

CM.save("figure1.png", fig)
fig
