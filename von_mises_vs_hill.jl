...
m_chaboche_hill = ChabocheHill(G=80e3, K=160e3, Y=100.0, Hiso=100.0, κ∞=400.0, Hkin=0.0, β∞=50.0,
                                    G_Hill=G_Hill, H_Hill=H_Hill, F_Hill=F_Hill,
                                    K_Hill=K_Hill, L_Hill=L_Hill, M_Hill=M_Hill)
                               
m_chaboche_vm = ChabocheHill(G=80e3, K=160e3, Y=100.0, Hiso=100.0, κ∞=400.0, Hkin=0.0, β∞=50.0,
                                    G_Hill=Gvm, H_Hill=Hvm, F_Hill=Fvm,
                                    K_Hill=Kvm, L_Hill=Lvm, M_Hill=Mvm)
...
function plot_results!(ax1, ax2,  m::AbstractMaterial, ϵ11, ϵ12; label="", t = collect(range(0,1,length(ϵ11))))
    ...
    CM.lines!(ax1, ϵ11, σ11; label=label)
    CM.lines!(ax2, ϵ12, σ12; label=label)
...
fig, ax1, ax2 = plot_results(m_chaboche_hill, ϵ11_case2, ϵ12_case2)
plot_results!(ax1, ax2, m_chaboche_vm, ϵ11_case2, ϵ12_case2; label="vm")
