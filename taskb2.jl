...
function main_demo_chabocheHill()
...
m_chaboche_hill = ChabocheHill(G=80e3, K=160e3, Y=250.0, Hiso=100e3, κ∞=400.0, Hkin=40e3, β∞=50.0,
...
function plot_results(m::AbstractMaterial, ϵ11::Vector, ϵ12::Vector; kwargs...)
    fig = CM.Figure()
    t= "Figure 8. Stress vs. time graphs for normal and shear stresses obtained for three different cases."
    ax1 = CM.Axis(fig[1,1];xlabel = "Time", ylabel = "σ₁₁ [MPa]", title="σ₁₁ vs Time")
    ax2 = CM.Axis(fig[2,1]; xlabel = "Time", ylabel = "σ₁₂ [MPa]", title="σ₁₂ vs Time")
...
# Case 1: ϵ11 ≠ 0, ϵ12 = 0
ϵ11_case1 = get_cycles(amplitude=0.01, num_cycles=1, num_steps_per_cycle=100)
ϵ12_case1 = zeros(100)
...
# Case 2: ϵ11 = ϵ12 ≠ 0
ϵ11_case2 = get_cycles(amplitude=0.01, num_cycles=1, num_steps_per_cycle=100)
ϵ12_case2 = ϵ11_case2
...
# Case 3: ϵ11 = 0, ϵ12 ≠ 0
ϵ11_case3 = zeros(100)
ϵ12_case3 = get_cycles(amplitude=0.01, num_cycles=1, num_steps_per_cycle=100)
